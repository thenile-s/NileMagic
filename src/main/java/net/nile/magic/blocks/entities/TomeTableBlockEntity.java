package net.nile.magic.blocks.entities;
...
public class TomeTableBlockEntity extends BlockEntity implements Nameable, Tickable {
    public TomeTableBlockEntity() {
        super(Blocks.TOME_TABLE_ENTITY);
    }
