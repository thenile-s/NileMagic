 ...
 * Originally by Juuz
 * 
 * And horrendously modified by The Jungle Tyrant
 */

public class ImplementedInventory implements Inventory {

    private DefaultedList<ItemStack> m_items;

    public ImplementedInventory(int size){
        m_items = DefaultedList.ofSize(size, ItemStack.EMPTY);
    }
